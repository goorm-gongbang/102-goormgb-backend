...
public class TeamSeasonStats extends BaseEntity {
    ...
    @Builder
    public TeamSeasonStats(Club club, int seasonYear, int seasonRanking, int wins, int draws, int losses, BigDecimal winRate, BigDecimal battingAverage, BigDecimal era, BigDecimal gamesBehind) {
        this.club = club;
